  ...
  <body>
      <div class="container">
          ...
          <div class="content">
              ...
              <p style="color: #ff0000; font-weight: bold;">This OTP will expire in 5 minutes.</p>
...
export const Resend_OTP_Template = `
  ...
  <body>
      <div class="container">
          <div class="header">New OTP Code</div>
          <div class="content">
              <p>Hello {name},</p>
...
// Template Functions for Easy Usage
export const getVerificationEmailTemplate = (name, otp) => {
  return Verification_Email_Template.replace(/{name}/g, name).replace(
    /{verificationCode}/g,
    otp
  );
};
...
export const getPasswordResetTemplate = (name, otp) => {
  return Password_Reset_Template.replace(/{name}/g, name).replace(
    /{verificationCode}/g,
    otp
  );
};

export const getResendOTPTemplate = (name, otp) => {
  return Resend_OTP_Template.replace(/{name}/g, name).replace(
    /{verificationCode}/g,
    otp
  );
};
...
export const getWelcomeEmailTemplate = (name) => {
  return Welcome_Email_Template.replace(/{name}/g, name);
};
